    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="bg-card rounded-lg shadow">
        ...
        <div className="p-4">
          <textarea
            id="jsonInput"
            className="block w-full h-[55vh] px-3 py-2 border border-input rounded-md shadow-sm bg-background text-foreground focus:outline-none focus:ring-primary focus:border-primary font-mono text-sm"

    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="bg-card rounded-lg shadow">
        ...
        <div className="p-4">
          <textarea
            id="jsonInput"
            className="block w-full h-[70vh] px-3 py-2 border border-input rounded-md shadow-sm bg-background text-foreground focus:outline-none focus:ring-primary focus:border-primary font-mono text-sm"
      ...
      <div className="bg-card rounded-lg shadow">
        ...
        <div className="p-4">
          <pre 
            id="jsonOutput" 
            className="block w-full h-96 px-3 py-2 bg-muted border border-input rounded-md shadow-inner overflow-auto font-mono text-sm resize-y"

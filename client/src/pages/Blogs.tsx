...
export default function Blogs() {
  return (
    <div className="bg-primary/5 py-8">
      ...
      <div className="py-8 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto px-4">
        {blogPosts.map((post) => (
          <Link key={post.slug} href={`/blogs/${post.slug}`}>
            <div className="border p-4 rounded-lg hover:shadow cursor-pointer transition">
